;;; doom-tomorrow-night-custom-theme.el -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)

(defgroup doom-tomorrow-night-custom-theme nil
  "Options for the `doom-tomorrow-night-custom' theme."
  :group 'doom-themes)

(defcustom doom-tomorrow-night-custom-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'doom-tomorrow-night-custom-theme
...
(def-doom-theme doom-tomorrow-night-custom
  ...
  ((bg         '("#1d1f21" nil       nil          ))
   ...
   (grey       '("#7a7b7a" "#7a7a7a" "brightblack"))
   ...
   (-modeline-pad
    (when doom-tomorrow-night-custom-padded-modeline
      (if (integerp doom-tomorrow-night-custom-padded-modeline)
          doom-tomorrow-night-custom-padded-modeline
        4))))
...
;;; doom-tomorrow-night-custom-theme.el ends here
